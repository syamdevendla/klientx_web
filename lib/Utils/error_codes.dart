...
String errorCode(String err) {
  ...
  switch (err) {
    ...
    case "7011":
      ...
      break;
    case "7012":
      s = "Failed to validate purchase code. Please try again. If it still continues report it to contact@klientx.com";
      break;
    case "7013":
      ...
      break;
    case "7014":
      s = "Project source code or License is tampered.  Kindly report it to contact@klientx.com . ";
      break;
    case "7015":
      s = "Source code version has already been updated using this License  ";
      break;
    case "7016":
      s = "License is Invalidated due to License violation. You can report it to contact@klientx.com  ";
      break;
    ...
    case "7057":
      ...
      break;
    case "7058":
      s = "Failed to validate. Kindly report it to contact@klientx.com  ";
      break;
    case "7059":
      s = "This Project cannot use any License.  ";
      break;
    ...
    case "7061":
      ...
      break;
    case "7062":
      s = "License is Invalidated due to License violation. For any information, you can connect with us at : contact@klientx.com ";
      break;
    case "7063":
      s = "Failed to validate license. Please try again. If it still continues kindly report it to us.  ";
      break;
    ...
    case "7094":
      ...
      break;
    case "7095":
      s = "Failed to validate. If it still continues kindly report it to contact@klientx.com.  ";
      break;
    case "7096":
      s = "Failed to validate. If it still continues kindly report it to contact@klientx.com.  ";
      break;
    ...
    case "7106":
      ...
      break;
    case "7107":
      s = "Failed to validate. Please try again. If it still continues kindly report it to contact@klientx.com ";
      break;
    case "7108":
      s = "Failed to validate. Please try again. If it still continues kindly report it to contact@klientx.com";
      break;
    ...
    case "7110":
      ...
      break;
    case "7111":
      s = "Failed to validate license. Please try again. If it still continues kindly report it to contact@klientx.com  ";
      break;
    case "7112":
      s = "Failed to validate license. Please try again. If it still continues kindly report it to contact@klientx.com  ";
      break;
    ...
    case "7120":
      ...
      break;
    case "7121":
      s = "unexpected Error occured. If it still continues kindly report it to contact@klientx.com  ";
      break;
    case "7122":
      s = "unexpected Error occured. If it still continues kindly report it to contact@klientx.com    ";
      break;
