...
class CustomerTicketsState extends State<CustomerTickets>
  ...
  getOrgData(orgId) async {
    ...
    await FirebaseFirestore.instance
        ...
        .get()
        .then((orgData) {
      items.add(orgData.data()!['orgName']);
      items.add(orgData.data()!['orgphotourl']);
      //print(orgData.data()!['orgName']);
      //print(orgData.data()!['orgphotourl']);
    });
    return items;
  }

  loadAndListenTickets() async {
    print("syam prints  customer_tickets - loadAndListenTickets");
    await FirebaseFirestore.instance
