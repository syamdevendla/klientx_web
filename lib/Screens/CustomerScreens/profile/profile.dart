                  ...
                  child: ListTile(
                    ...
                    subtitle: Row(
                      ...
                      children: [
                        ...
                        roleBasedSticker(this.context, Usertype.customer.index)
                      ],
                    ),
                  ),
                ),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    // profileTile(
                    //   title: getTranslatedForCurrentUser(this.context, 'xxratexx'),
                    //   subtitle: getTranslatedForCurrentUser(this.context, 'xxleavereviewxx'),
                    //   ontap: () {
                    //     onTapRateApp();
                    //   },
                    //   iconsize: 23,
                                                    ...
                                                    onPressed: () async {
                                                      ...
                                                      await FirebaseApi
                                                          .runTransactionRecordActivity(
                                                              ...
                                                              title:
                                                                  'Account Deletion Request by Customer',
                                                              plainDesc:
                                                                  'Customer ID: ${widget.currentUserID} has requested to Delete account. Delete it from Customer Profile page. User Data, Chats, Profile Details will be deleted.',
                                                              onErrorFn: (e) {
                                                                showModalBottomSheet(
                                                                    isScrollControlled:
                                                                        true,
