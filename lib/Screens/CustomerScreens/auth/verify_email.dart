...
import 'package:aagama_it/Screens/CustomerScreens/auth/email_verification_page.dart';
    ...
    try {
      ...
      if (e.code == 'invalid-email') {
        ...
        if (widget.basicSettings.customerRegistationEnabled == true) {
          ...
          Navigator.of(this.context).pop();
          showERRORSheet(this.context, "EM_124",
      ...
      if (e.toString().contains("no user") ||
        ...
        if (widget.basicSettings.customerRegistationEnabled == true) {
          ...
          Navigator.of(this.context).pop();
          showERRORSheet(this.context, "EM_101",
              message: getTranslatedForCurrentUser(
                      this.context, 'xxemailnotfoundlxx')
                  .replaceAll(
                      '(####)',
        ...
        if (e.toString().contains("does not have a password")) {
          ...
          showERRORSheet(this.context, "EM_111",
              message:
                  "${getTranslatedForCurrentUser(this.context, 'xxfailedxx')}\n\n Error: ${getTranslatedForCurrentUser(this.context, 'xxcannotuseemailxx')}");
          ...
          if (widget.basicSettings.customerRegistationEnabled == true) {
            ...
            Navigator.of(this.context).pop();
            showERRORSheet(this.context, "EM_123",
                message: getTranslatedForCurrentUser(
                        this.context, 'xxemailnotfoundlxx')
                    .replaceAll(
                        '(####)',
      ...
      await FirebaseFirestore.instance
        ...
        if (agentList.docs.length > 0) {
          ...
          showERRORSheet(this.context, "EM_105",
              message:
                  "${getTranslatedForCurrentUser(this.context, 'xxfailedxx')}\n\n. Error: ${getTranslatedForCurrentUser(this.context, 'xxalreadyregistereddescxx').replaceAll('(####)', widget.email).replaceAll('(###)', getTranslatedForCurrentUser(this.context, 'xxagentxx')).replaceAll('(##)', getTranslatedForCurrentUser(this.context, 'xxcustomerxx'))}");
        } else {
          if (customerList.docs.length == 0) {
            if (widget.basicSettings.customerRegistationEnabled == true) {
              ...
              showERRORSheet(this.context, "EM_108",
                  message:
                      "${getTranslatedForCurrentUser(this.context, 'xxfailedxx')}\n\n ${getTranslatedForCurrentUser(this.context, 'xxemailnotfoundlxx')}");
            }
